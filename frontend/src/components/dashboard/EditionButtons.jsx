...
export const EditionButtons = ({ selected, onBulkActionClick }) => {
    ...
    return (
        <div className="flex items-center justify-end gap-4 mt-4">
            ...
            {/*<Button size="sm" onClick={() => onBulkActionClick("read")} disabled={selected.length === 0}>*/}
            {/*    Read Selected*/}
            {/*</Button>*/}
            {/*<Button size="sm" variant="secondary" onClick={() => onBulkActionClick("unread")} disabled={selected.length === 0}>*/}
            {/*    Unread Selected*/}
            {/*</Button>*/}
