...
function PrivacyPolicyPage() {
    return (
        <PageTitle title="Privacy Policy" subtitle="Protection of your data: Privacy and Security">
            <p className="mt-2">
                At ScienceFeed.info, accessible at <a href="https://science-feed.info">ScienceFeed.info</a>, one of our main
                priorities is the privacy of our visitors. This Privacy Policy document contains types of
                information that is collected and recorded by ScienceFeed.info and how we use it.
            </p>
            <p>
                If you have additional questions or require more information about our Privacy Policy, do not
                hesitate to contact us through email at <a href={`mailto:${mail}`}>ScienceFeed.info</a>.
            </p>
            <p>
                This privacy policy applies only to our online activities and is valid for visitors to our website
                with regards to the information that they shared and/or collect in ScienceFeed.info. This policy is not
            ...
            <p>
                ScienceFeed.info follows a standard procedure of using log files. These files log visitors when they
            ...
            <p>
                Like any other website, ScienceFeed.info uses ‘cookies'. These cookies are used to store information
            ...
            <p>
                ScienceFeed.info does not knowingly collect any Personal Identifiable Information from children under
