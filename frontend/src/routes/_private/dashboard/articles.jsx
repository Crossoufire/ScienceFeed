...
import {dashboardArticlesOptions} from "@/api/queryOptions";
...
import {useArchiveArticles, useDeleteArticles, useRssFetcher,} from "@/api/mutations";
...
export const Route = createFileRoute("/_private/dashboard/articles")({
    ...
    loader: ({ context: { queryClient }, deps: { search } }) => queryClient.ensureQueryData(dashboardArticlesOptions(search)),
});
